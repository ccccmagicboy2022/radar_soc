...
{
    if (!flag)
        *data = ((i2c_unit->R_DATA0) >> (pos * 8)) & 0xff;
    else
        *data = ((i2c_unit->R_DATA1) >> (pos * 8)) & 0xff;
}
...
void I2C_config_slave_addr(brx820_i2c_master_regdef *i2c_unit, uint8_t slave_addr)
{
    ...
    i2c_unit->SLAVE_ADDR = slave_addr << 1;
}
...
void I2C_master_set_transmit_buffer(brx820_i2c_master_regdef *i2c_unit, uint8_t slot, uint8_t val)
{
    ...
    {
        case 0:
            i2c_unit->T_DATA0_SLOT0 = val;
            break;
        case 1:
            i2c_unit->T_DATA0_SLOT1 = val;
            break;
        case 2:
            i2c_unit->T_DATA0_SLOT2 = val;
            break;
        case 3:
            i2c_unit->T_DATA0_SLOT3 = val;
            break;
        case 4:
            i2c_unit->T_DATA1_SLOT4 = val;
            break;
        case 5:
            i2c_unit->T_DATA1_SLOT5 = val;
            break;
        case 6:
            i2c_unit->T_DATA1_SLOT6 = val;
            break;
        case 7:
            i2c_unit->T_DATA1_SLOT7 = val;
            break;
        default:
            break;
    }
